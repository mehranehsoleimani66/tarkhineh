...
<>
           ...
           <div className="flex flex-row-reverse ">
            ...
            <Input className="text-right text-white  border rounded-lg"  value={name} placeholder='نام نام خانوادگی' onChange={(e)=>{setName(e.target.value)}}/>
            <Input className="text-right bg-transparent border rounded-lg"   placeholder='شماره تماس' value={num} onChange={(e)=>{setNum(e.target.value)}}/>
            <Input className="text-right bg-transparent border rounded-lg" type='email' placeholder='آدرس ایمیل(اختیاری)' value={email} onChange={(e)=>{setEMail(e.target.value)}} />
             </div>
